...
DEFAULT_ICON_DIR = PROJECT_ROOT / "media" / "sst_component_icons"
DEFAULT_OVERRIDE_FILE = PROJECT_ROOT / "config" / "sst_icon_overrides.csv"
RELATIVE_ICON_DIR = Path("media") / "sst_component_icons"
